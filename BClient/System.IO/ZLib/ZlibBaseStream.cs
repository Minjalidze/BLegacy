...
namespace System.IO.Compression.Zlib
{
    ...
    internal class ZlibBaseStream : System.IO.Stream
    {
        ...
        // workitem 7159
        System.IO.Compression.CRC32 crc;
        ...
        public ZlibBaseStream(System.IO.Stream stream, CompressionMode compressionMode, CompressionLevel level, ZlibStreamFlavor flavor, bool leaveOpen) : base()
        {
            ...
            {
                this.crc = new System.IO.Compression.CRC32();
            }
        }
       ...
       public override void Write(System.Byte[] buffer, int offset, int count)
        {
            ...
            do
            {
                ...
                if (rc != ZlibConstants.Z_OK && rc != ZlibConstants.Z_STREAM_END) throw new ZlibException((_wantCompress ? "de" : "in") + "flating: " + _z.Message);
                ...
                if (_flavor == ZlibStreamFlavor.GZIP && !_wantCompress) done = (_z.AvailableBytesIn == 8 && _z.AvailableBytesOut != 0);
                ...
                if (_flavor == ZlibStreamFlavor.GZIP)
                {
                    if (!_wantCompress)
                    {
                        ...
                        if (_z.AvailableBytesIn < 8)
                        {
                            ...
                            var bytesRead = _stream.Read(trailer, _z.AvailableBytesIn, bytesNeeded);
                        ...
                        if (crc32_actual != crc32_expected) throw new ZlibException(
                            $"Bad CRC32 in GZIP trailer. (actual({crc32_actual:X8})!=expected({crc32_expected:X8}))");
                        if (isize_actual != isize_expected) throw new ZlibException(
        ...
        private string ReadZeroTerminatedString()
        {
            ...
            do
            {
                ...
                if (n != 1) throw new ZlibException("Unexpected EOF reading GZIP header."); else
                {
                    if (_buf1[0] == 0) done = true; else list.Add(_buf1[0]);
                }
            } while (!done);
            var a = list.ToArray();
        ...
        public override System.Int32 Read(System.Byte[] buffer, System.Int32 offset, System.Int32 count)
        {
            ...
            do
            {
                ...
                if ((nomoreinput || rc == ZlibConstants.Z_STREAM_END) && (_z.AvailableBytesOut == count)) break; // nothing more to read
            }
            ...
            if (_z.AvailableBytesOut > 0)
            {
                ...
                if (nomoreinput)
                {
                    ...
                    if (_wantCompress)
                    {
                        ...
                        if (rc != ZlibConstants.Z_OK && rc != ZlibConstants.Z_STREAM_END) throw new ZlibException(
                            $"Deflating:  rc={rc}  msg={_z.Message}");
                    }
                }
            }

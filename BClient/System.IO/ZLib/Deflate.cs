...
namespace System.IO.Compression.Zlib
{
    ...
    internal sealed class DeflateManager
    {
        ...
        internal bool _tr_tally(int dist, int lc)
        {
            ...
            {
                matches++; dist--; // dist = match distance - 1
            ...
            if ((last_lit & 0x1fff) == 0 && (int)compressionLevel > 2)
            {
                ...
                var in_length = strstart - block_start; int dcode;
        ...
        internal BlockState DeflateNone(FlushType flush)
        {
            ...
            if (_codec.AvailableBytesOut == 0) return (flush == FlushType.Finish) ? BlockState.FinishStarted : BlockState.NeedMore;
        ...
        internal BlockState DeflateSlow(FlushType flush)
        {
            ...
            if (_codec.AvailableBytesOut == 0)
            {
                if (flush == FlushType.Finish) return BlockState.FinishStarted; else return BlockState.NeedMore;
            }
            return flush == FlushType.Finish ? BlockState.FinishDone : BlockState.BlockDone;
        }
        ...
        internal int Initialize(ZlibCodec codec, CompressionLevel level, int windowBits, int memLevel, CompressionStrategy strategy)
        {
            ...
            if (memLevel < 1 || memLevel > MEM_LEVEL_MAX) throw new ZlibException(
                $"memLevel must be in the range 1.. {MEM_LEVEL_MAX}");

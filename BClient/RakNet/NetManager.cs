...
namespace RakNet
{
    ...
    internal sealed class NetEvent
    {
        ...
        internal ConnectionRequest ConnectionRequest;
        internal DeliveryMethod DeliveryMethod;
        internal readonly NetPacketReader DataReader;

        internal NetEvent(NetManager manager)
        {
    ...
    public class NetManager : IEnumerable<NetPeer>
    {
        ...
        internal struct NetPeerEnumerator : IEnumerator<NetPeer>
        {
            private readonly NetPeer _initialPeer;
            private NetPeer _p;

            internal NetPeerEnumerator(NetPeer p)
            {
                _initialPeer = p;
                _p = null;
            }
        ...
        {
            internal NetPacket Data;
            internal IPEndPoint EndPoint;
            internal DateTime TimeWhenGet;
        }
        ...
        /// </summary>
        internal bool UnconnectedMessagesEnabled = false;

        /// <summary>
        /// Enable nat punch messages
        /// </summary>
        internal bool NatPunchEnabled = false;

        /// <summary>
        /// Library logic update and send period in milliseconds
        /// </summary>
        internal int UpdateTime = 15;

        /// <summary>
        /// Interval for latency detection and checking connection
        /// </summary>
        internal int PingInterval = 1000;

        /// <summary>
        /// If NetManager doesn't receive any packet from remote peer during this time then connection will be closed
        /// (including library internal keepalive packets)
        /// </summary>
        internal int DisconnectTimeout = 5000;

        /// <summary>
        /// Simulate packet loss by dropping random amount of packets. (Works only in DEBUG mode)
        /// </summary>
        internal bool SimulatePacketLoss = false;

        /// <summary>
        /// Simulate latency by holding packets for random time. (Works only in DEBUG mode)
        /// </summary>
        internal bool SimulateLatency = false;

        /// <summary>
        /// Chance of packet loss when simulation enabled. value in percents (1 - 100).
        /// </summary>
        internal int SimulationPacketLossChance = 10;

        /// <summary>
        /// Minimum simulated latency
        /// </summary>
        internal int SimulationMinLatency = 30;

        /// <summary>
        /// Maximum simulated latency
        /// </summary>
        internal int SimulationMaxLatency = 100;

        /// <summary>
        /// Events automatically will be called without PollEvents method from another thread
        /// </summary>
        internal bool UnsyncedEvents = false;

        /// <summary>
        /// If true - receive event will be called from "receive" thread immediately otherwise on PollEvents call
        /// </summary>
        internal bool UnsyncedReceiveEvent = false;

        /// <summary>
        /// If true - delivery event will be called from "receive" thread immediately otherwise on PollEvents call
        /// </summary>
        internal bool UnsyncedDeliveryEvent = false;

        /// <summary>
        /// Allows receive broadcast packets
        /// </summary>
        internal bool BroadcastReceiveEnabled = false;

        /// <summary>
        /// Delay between initial connection attempts
        /// </summary>
        internal int ReconnectDelay = 500;

        /// <summary>
        /// Maximum connection attempts before client stops and call disconnect event.
        /// </summary>
        internal int MaxConnectAttempts = 10;

        /// <summary>
        /// Enables socket option "ReuseAddress" for specific purposes
        /// </summary>
        internal bool ReuseAddress = false;

        /// <summary>
        /// Statistics of all connections
        /// </summary>
        internal readonly NetStatistics Statistics;

        /// <summary>
        /// Toggles the collection of network statistics for the instance and all known peers
        /// </summary>
        internal bool EnableStatistics = false;

        /// <summary>
        /// NatPunchModule for NAT hole punching operations
        /// </summary>
        internal readonly NatPunchModule NatPunchModule;

        /// <summary>
        /// Returns true if socket listening and update thread is running
        /// </summary>
        internal bool IsRunning { get { return _socket.IsRunning; } }

        /// <summary>
        /// Local EndPoint (host and port)
        /// </summary>
        internal int LocalPort { get { return _socket.LocalPort; } }

        /// <summary>
        /// Automatically recycle NetPacketReader after OnReceive event
        /// </summary>
        internal bool AutoRecycle;

        /// <summary>
        /// IPv6 support
        /// </summary>
        internal IPv6Mode IPv6Enabled = IPv6Mode.SeparateSocket;
        ...
        /// </summary>
        internal bool UseSafeMtu = false;

        /// <summary>
        /// First peer. Useful for Client mode
        /// </summary>
        internal NetPeer FirstPeer
        {
        ...
        /// </summary>
        internal bool DisconnectOnUnreachable = false;
        ...
        /// </summary>
        internal List<NetPeer> ConnectedPeerList
        {
            get
            {
        ...
        internal NetPeer GetPeerById(int id)
        {
        ...
        /// </summary>
        internal int ConnectedPeersCount { get { return _connectedPeersCount; } }

        internal int ExtraPacketSizeForLayer
        {
        ...
        internal NetManager(INetEventListener listener, PacketLayerBase extraPacketLayer = null)
        {
        ...
        internal void ManualUpdate(int elapsedMilliseconds)
        {
            if (!_manualMode)
                return;
        ...
        internal void SendToAll(NetDataWriter writer, DeliveryMethod options)
        {
        ...
        /// <param name="options">Send options (reliable, unreliable, etc.)</param>
        internal void SendToAll(byte[] data, DeliveryMethod options)
        {
        ...
        /// <param name="options">Send options (reliable, unreliable, etc.)</param>
        internal void SendToAll(byte[] data, int start, int length, DeliveryMethod options)
        {
        ...
        /// <param name="options">Send options (reliable, unreliable, etc.)</param>
        internal void SendToAll(NetDataWriter writer, byte channelNumber, DeliveryMethod options)
        {
        ...
        /// <param name="channelNumber">Number of channel (from 0 to channelsCount - 1)</param>
        /// <param name="options">Send options (reliable, unreliable, etc.)</param>
        internal void SendToAll(byte[] data, byte channelNumber, DeliveryMethod options)
        {
        ...
        /// <param name="channelNumber">Number of channel (from 0 to channelsCount - 1)</param>
        /// <param name="options">Send options (reliable, unreliable, etc.)</param>
        internal void SendToAll(byte[] data, int start, int length, byte channelNumber, DeliveryMethod options)
        {
            try
            {
                _peersLock.EnterReadLock();
        ...
        internal void SendToAll(NetDataWriter writer, DeliveryMethod options, NetPeer excludePeer)
        {
        ...
        /// <param name="options">Send options (reliable, unreliable, etc.)</param>
        /// <param name="excludePeer">Excluded peer</param>
        internal void SendToAll(byte[] data, DeliveryMethod options, NetPeer excludePeer)
        {
        ...
        /// <param name="options">Send options (reliable, unreliable, etc.)</param>
        /// <param name="excludePeer">Excluded peer</param>
        internal void SendToAll(byte[] data, int start, int length, DeliveryMethod options, NetPeer excludePeer)
        {
        ...
        /// <param name="options">Send options (reliable, unreliable, etc.)</param>
        /// <param name="excludePeer">Excluded peer</param>
        internal void SendToAll(NetDataWriter writer, byte channelNumber, DeliveryMethod options, NetPeer excludePeer)
        {
        ...
        /// <param name="options">Send options (reliable, unreliable, etc.)</param>
        /// <param name="excludePeer">Excluded peer</param>
        internal void SendToAll(byte[] data, byte channelNumber, DeliveryMethod options, NetPeer excludePeer)
        {
        ...
        /// <param name="options">Send options (reliable, unreliable, etc.)</param>
        /// <param name="excludePeer">Excluded peer</param>
        internal void SendToAll(byte[] data, int start, int length, byte channelNumber, DeliveryMethod options, NetPeer excludePeer)
        {
            try
            {
                _peersLock.EnterReadLock();
        ...
        internal bool Start(IPAddress addressIPv4, int port)
        {
            _manualMode = false;
            if (!_socket.Bind(addressIPv4, port, ReuseAddress, false))
                return false;
        ...
        /// <param name="addressIPv6">bind to specific ipv6 address</param>
        /// <param name="port">port to listen</param>
        internal bool Start(string addressIPv4, string addressIPv6, int port)
        {
            var ipv4 = NetUtils.ResolveAddress(addressIPv4);
            var ipv6 = NetUtils.ResolveAddress(addressIPv6);
            return Start(ipv4, port);
        }
        ...
        {
            return Start(IPAddress.Any, port);
        }
        ...
        /// <param name="addressIPv6">bind to specific ipv6 address</param>
        /// <param name="port">port to listen</param>
        internal bool StartInManualMode(IPAddress addressIPv4, int port)
        {
            _manualMode = true;
            if (!_socket.Bind(addressIPv4, port, ReuseAddress, true))
                return false;
            return true;
        }
        ...
        /// <param name="addressIPv6">bind to specific ipv6 address</param>
        /// <param name="port">port to listen</param>
        internal bool StartInManualMode(string addressIPv4, int port)
        {
            var ipv4 = NetUtils.ResolveAddress(addressIPv4);
            return StartInManualMode(ipv4, port);
        }
        ...
        /// </summary>
        /// <param name="port">port to listen</param>
        internal bool StartInManualMode(int port)
        {
            return StartInManualMode(IPAddress.Any, port);
        }
        ...
        internal bool SendUnconnectedMessage(byte[] message, IPEndPoint remoteEndPoint)
        {
        ...
        /// <param name="remoteEndPoint">Packet destination</param>
        /// <returns>Operation result</returns>
        internal bool SendUnconnectedMessage(NetDataWriter writer, IPEndPoint remoteEndPoint)
        {
        ...
        /// <param name="remoteEndPoint">Packet destination</param>
        /// <returns>Operation result</returns>
        internal bool SendUnconnectedMessage(byte[] message, int start, int length, IPEndPoint remoteEndPoint)
        {
        ...
        internal bool SendBroadcast(NetDataWriter writer, int port)
        {
            return SendBroadcast(writer.Data, 0, writer.Length, port);
        }

        internal bool SendBroadcast(byte[] data, int port)
        {
            return SendBroadcast(data, 0, data.Length, port);
        }

        internal bool SendBroadcast(byte[] data, int start, int length, int port)
        {
            NetPacket packet;
            if (_extraPacketLayer != null)
            {
        ...
        internal NetPeer Connect(string address, int port, string key)
        {
        ...
        /// <returns>New NetPeer if new connection, Old NetPeer if already connected, null peer if there is ConnectionRequest awaiting</returns>
        /// <exception cref="InvalidOperationException">Manager is not running. Call <see cref="Start()"/></exception>
        internal NetPeer Connect(string address, int port, NetDataWriter connectionData)
        {
            IPEndPoint ep;
            try
            {
        ...
        /// <returns>New NetPeer if new connection, Old NetPeer if already connected, null peer if there is ConnectionRequest awaiting</returns>
        /// <exception cref="InvalidOperationException">Manager is not running. Call <see cref="Start()"/></exception>
        internal NetPeer Connect(IPEndPoint target, string key)
        {
        ...
        /// <returns>New NetPeer if new connection, Old NetPeer if already connected, null peer if there is ConnectionRequest awaiting</returns>
        /// <exception cref="InvalidOperationException">Manager is not running. Call <see cref="Start()"/></exception>
        internal NetPeer Connect(IPEndPoint target, NetDataWriter connectionData)
        {
            if (!_socket.IsRunning)
        ...
        internal void Stop(bool sendDisconnectMessages)
        {
            if (!_socket.IsRunning)
                return;
        ...
        internal int GetPeersCount(ConnectionState peerState)
        {
            var count = 0;
            _peersLock.EnterReadLock();
            for (var netPeer = _headPeer; netPeer != null; netPeer = netPeer.NextPeer)
        ...
        internal void GetPeersNonAlloc(List<NetPeer> peers, ConnectionState peerState)
        {
            peers.Clear();
            _peersLock.EnterReadLock();
            for (var netPeer = _headPeer; netPeer != null; netPeer = netPeer.NextPeer)
        ...
        internal void DisconnectAll(byte[] data, int start, int count)
        {
        ...
        /// </summary>
        /// <param name="peer">peer to disconnect</param>
        internal void DisconnectPeer(NetPeer peer)
        {
        ...
        internal void DisconnectPeer(NetPeer peer, byte[] data)
        {
        ...
        internal void DisconnectPeer(NetPeer peer, NetDataWriter writer)
        {
        ...
        internal void DisconnectPeer(NetPeer peer, byte[] data, int start, int count)
        {
            DisconnectPeer(
                peer, 
                DisconnectReason.DisconnectPeerCalled, 
        ...
        internal void CreateNtpRequest(IPEndPoint endPoint)
        {
        ...
        internal void CreateNtpRequest(string ntpServerAddress, int port)
        {
        ...
        /// </summary>
        /// <param name="ntpServerAddress">NTP Server address.</param>
        internal void CreateNtpRequest(string ntpServerAddress)
        {
            var endPoint = NetUtils.MakeEndPoint(ntpServerAddress, NtpRequest.DefaultPort);
            _ntpRequests.Add(endPoint, new NtpRequest(endPoint));
        }

        internal NetPeerEnumerator GetEnumerator()
        {

...
#pragma warning restore 618
#else
            IPv6Support = System.Net.Sockets.Socket.OSSupportsIPv6;
#endif
        }
        ...
        private bool ManualReceive(System.Net.Sockets.Socket socket, EndPoint bufferEndPoint)
        {
            //Reading data
            try
            {
        ...
        public bool Bind(IPAddress addressIPv4, int port, bool reuseAddress, bool manualMode)
        {
            if (IsActive())
                return false;
            
            _udpSocketv4 = new System.Net.Sockets.Socket(
                addressIPv4.AddressFamily, 
                SocketType.Dgram, 
                ProtocolType.Udp);
            ...
            {
                var unityFixObj = new GameObject("RakNet_UnitySocketFix");
        ...
        private bool BindSocket(System.Net.Sockets.Socket socket, IPEndPoint ep, bool reuseAddress)
        {
            //Setup socket

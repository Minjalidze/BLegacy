...
namespace Oxide.Plugins
{
    ...
    class FastAnnouncer : RustLegacyPlugin
    {
        ...
        int ChatModerRank = 37;   
        int CheckPlayerRank = 37;   
        int AnnounceMinimumRank = 37;        
        int ChatAdminRank = 39; 

        /*======== Commands Syntax ======== */
        string cError = "[COLOR #FF0000]";
        string cSyntax = "[COLOR #FFEC00]";

        /*========== Chat Name ============ */
        static string ChatName = "uHelper";
		
        /*========== Chat Colors ==========*/
        string chatAdmin = "[COLOR #FF0000]";
        string chatModer = "[COLOR #00FF00]";
        ...
        void CheckPlayer(NetUser player, string cmdd, string[] args)
        {
            ...
            string text = playerNick + " дискорд/скайп на проверку " + sec + " секунд! [Выход == БАН] [Игнор == БАН] Проверяет: " + moderNick;
        ...
        void BanPlayer(NetUser player, string cmdd, string[] args)
        {
            ...
            string text = playerNick + " Banned! || Забанил: " + moderNick;
